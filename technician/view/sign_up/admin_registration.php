...
<body>
    ...
    <form action="../../control/admin_reg_control.php" method="POST">
        <fieldset>
            ...
            <table>
                <tr>
                    ...
                    <td>Father's Name :</td>
                    <td><input type="text" name="fatname" placeholder="Enter Father's Name" ></td>
                </tr>
                <tr>
                <td>Gender :</td>
                    <td>
                ...
                <tr>
                    ...
                    <td><textarea name="preadress" id="" cols="30" rows="4" placeholder="Enter Your Present Address"></textarea></td>
                    <td>Photo  :</td>
                ...
                <tr>
                    ...
                    <td><textarea name="peradress" id="" cols="30" rows="4" placeholder="Enter Your Permanent Address"></textarea></td>
                </tr>
                <tr>
